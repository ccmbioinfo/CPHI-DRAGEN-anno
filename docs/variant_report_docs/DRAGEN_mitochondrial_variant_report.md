...
| `GB_SEQS` | The number of sequences containing this variant in MITOMAP'S full length set of GenBank sequences. | mity (mt_report) | 85 |
| `GB_FREQ` | Frequency of this variant in MITOMAP's GenBank sequence set, expressed as a decimal (e.g. 0.002 = 0.2%) | mity (mt_report) | 0.008 |
